...
def download_url_to_cache(
    ...
    *,
    ...
    cache_key = validate_url(cache_key_url) if cache_key_url else normalized_url
    url_hash = hashlib.sha256(cache_key.encode("utf-8")).hexdigest()
