...
from image_engine_app.app.ui_controller import PresetApplySummary  # noqa: E402
from image_engine_app.engine.models import AssetRecord, EditMode  # noqa: E402
from image_engine_app.ui.main_window.apply_coordinator import ApplyCoordinator  # noqa: E402
...
class ApplyCoordinatorTests(unittest.TestCase):
    def test_preset_resyncs_active_asset_when_auto_apply_disabled(self) -> None:
        ...
        self.assertEqual(1, window.controller.reset_calls)
