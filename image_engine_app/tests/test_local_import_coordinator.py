...
from app.ui_controller import LocalImportSummary  # noqa: E402
from engine.ingest.local_ingest import LocalIngestResult  # noqa: E402
from engine.ingest.zip_extract import ZipExtractError  # noqa: E402
from engine.models import AssetRecord, SourceType  # noqa: E402
from ui.main_window.local_import_coordinator import LocalImportCoordinator  # noqa: E402
...
class LocalImportCoordinatorTests(unittest.TestCase):
    def test_import_files_registers_assets_and_reports_summary(self) -> None:
        ...
        with patch(
            "ui.main_window.local_import_coordinator.QFileDialog.getOpenFileNames",
    ...
    def test_import_zip_archive_reports_extract_error(self) -> None:
        ...
        with patch(
            "ui.main_window.local_import_coordinator.QFileDialog.getOpenFileName",
            return_value=("C:/images/broken.zip", ""),
        ):
            with patch(
                "ui.main_window.local_import_coordinator.extract_images_only",
