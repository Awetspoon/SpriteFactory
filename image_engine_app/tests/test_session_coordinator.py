...
from app.settings_store import SessionStore  # noqa: E402
from engine.models import AssetRecord, SessionState, SourceType  # noqa: E402
from ui.main_window.session_coordinator import SessionCoordinator  # noqa: E402
...
class SessionCoordinatorTests(unittest.TestCase):
    def test_clear_session_discard_clears_workspace(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch(
                "ui.main_window.session_coordinator.QMessageBox.question",
    ...
    def test_clear_session_save_then_cancel_save_dialog_does_not_clear(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch(
                ...
                with patch("ui.main_window.session_coordinator.QFileDialog.getSaveFileName", return_value=("", "")):
                    coordinator.clear_session()
    ...
    def test_clear_session_without_content_skips_prompt(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("ui.main_window.session_coordinator.QMessageBox.question") as mocked_prompt:
                coordinator.clear_session()
