...
class EngineUIState(QObject):
    ...
    def __init__(self) -> None:
        ...
        self._export_prediction_text = "Predicted size: --"
    ...
    def set_performance_mode(self, mode_key: str) -> None:
        self._performance_mode = mode_key
        self.performance_mode_changed.emit(mode_key)
        self.status_message_changed.emit(f"Performance mode set to {mode_key.upper()}")
